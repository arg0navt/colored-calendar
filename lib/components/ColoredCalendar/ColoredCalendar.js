  ...
  function ColoredCalendar() {
    ...
    _this.setRange = function (value) {
      _this.setState(function (prevState) {
        ...
        return _this.props.switchDays(_this.state.activeRange);
      });
    };

    _this.setActiveMonth = function (type, date) {
      _this.setState(function (prevState) {
        prevState.activeMonths[type] = date;
        return prevState;
      }, function () {
        return _this.props.switchMonth(type, date);
      });
    };
...
ColoredCalendar.defaultProps = {
  format: "DD.MM.YY",
  initPicker: {
    from: (0, _moment2.default)().format("DD.MM.YY"),
    to: (0, _moment2.default)().add(1, "month").format("DD.MM.YY")
  },
  lang: "en",
  limit: 7,
  switchDays: function switchDays() {},
